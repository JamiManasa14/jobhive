...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-800 py-8 bg-slate-800">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-cyan-50">Job Hive</h2>
            <p className="text-sm text-cyan-50">© 2024 Job Hive. Empowering your next career move.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-gray-400 text-cyan-50" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-gray-400 text-cyan-50" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-400 text-cyan-50" aria-label="LinkedIn">
